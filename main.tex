...
Sie sind zum Beispiel Mitwirkende an dem Open Compute Project, welches ein Projekt ist um Leistungsfähige und kostengünstige Hardware 
Design mit unterschiedlichen Firmen zu teilen. (\parencite {openComp})
...
Bei dem letzen Punkt schreibt Zuckerberg dass er Firmen helfen möchten das Internet weiter auszubreiten, indem Facebook ein neues Konzept entwickelt welches Menschen online bringt.
Dieses neue Konzept wurde in wie fern umgesetzt: Die Menschen, in den Entwicklungsländern sollen erst mal nur den kostenlosen Zugang zu Dienstleistungen wie Facebook haben.
