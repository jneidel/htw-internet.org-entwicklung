...
Die folgende Arbeit beschäftigt sich mit der Entwicklung von `Internet.org" , welches Mark Zuckerberg als großes Projekt in Indien durchführen wollte, aber daran kläglich scheiterte. %Zu unformell ?
...
Wie diese Idee bei der Bevölkerung ankommt, inwiefern Facebook.inc dieses Konzept umsetzt und anschließend nach kurzer Zeit schon von der Regierung gebannt wird, wird in dieser Arbeit beleuchtet. 
