...
Auch ist die Qualität (Geschwindigkeit) des Services, welche 4-12 mal langsamer ist, lässt sich nicht mit dem eines zahlenden Kunden vergleichen.
Die langsame Verbindung hat dabei mehrere Gründe. Zum einen wird die Bandbreite von Reliance gedrosselt um den zahlenden Abonnenten Vorrang zu geben. Auch laufen alle Verbindungen durch einen Facebook Proxy Server in Europa! Dadurch die Route verlängert, es wird erneut gedrosselt und jegliche Verschlüsslung (TLS) wird umgangen (Vgl. \cite{walledGarden}).
...
Airtel Ankündigung wurde mit einer Welle der Entrüstung aufgenommen, worauf hin Airtel auch schnell von der Idee abließ.
